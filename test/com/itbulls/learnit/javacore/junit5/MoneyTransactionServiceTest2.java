 ...
 * 
 * - Standard - Simple - IndicativeSentences
 * 
 */
...
//	}
	...
	void shouldThrowNotEnoughMoneyExceptionWhenTransferMoreMoney() {
		...
		// WHEN
		assertThrows(NotEnoughMoneyException.class, () -> testInstance
	...
	void dependentAssertionsExample() {
		...
		assertAll("Money Transaction",
				() -> {
					//WHEN
					boolean isTransactionSuccesd = testInstance.transferMoney(account1, 
							account2, RANDOM_MONEY_AMOUNT);
