	...
	public static void main(String[] args) {
		...
		orderManagement.setDistanceCalculator(new DistanceCalculator() {
			...
			public double calculateDistance(City city1, City city2) {
				...
				return city1.getLogitude() - city2.getLogitude(); // some dummy
																	// calculations
			}
		});

		DistanceCalculator dCalculator = (city1, city2) -> city1.getLogitude()
				- city2.getLogitude();
...
//		city1.getLogitude() - city2.getLogitude());
...
class GoogleDistanceCalculator {
	...
	public static double getDistanceBetweenCitiesStatic(City city1,
			City city2) {
		return 1;
	}
