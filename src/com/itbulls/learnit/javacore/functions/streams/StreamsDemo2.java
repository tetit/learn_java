...
public class StreamsDemo2 {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println(
				"streamFromCollection = " + streamFromCollection.collect(Collectors.toList()));
		
		// Numeric stream from String
		IntStream streamFromString = "132".chars();
		...
		System.out.println(
				"streamFromIterate = " + streamFromIterate.limit(5).collect(Collectors.toList()));
		
		// Stream.generate
		Stream<String> streamFromGenerate = Stream.generate(() -> "a1");
		System.out.println(
				"streamFromGenerate = " + streamFromGenerate.limit(3).collect(Collectors.toList()));
	...
	private static  void testFilterAndCount() {
		...
		List<String> select = collection.stream().filter(s -> s.contains("1"))
		...
		double manAwerageAge = peoples.stream().filter(p -> p.getSex() == Sex.MAN)
				.mapToInt(People::getAge).average().getAsDouble();
		System.out.println("manAwerageAge" + manAwerageAge);
