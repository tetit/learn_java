package com.itbulls.learnit.javacore.methods.hw.it;
...
public class FilterStringArray {
	...
	public static String[] filterWordsByLengthStreamApi(int minLength,
			String[] words) {
		return Arrays.stream(words).filter(s -> s.length() >= minLength)
				.toArray(String[]::new);
	}
