package myProject.function.consumers;
...
public class ConsumerDemo {
	...
	public static void main(String[] args) {
		...
		idProductMap.put(2, new DefaultProduct(2, "Product 2", "Category 1", 149.99));
	...
	public static void increasePriceForProductList(List<? extends Product> products, 
			double priceToIcrease) {
		products.iterator().forEachRemaining(
				product -> product.setPrice(product.getPrice() + priceToIcrease));
	}
